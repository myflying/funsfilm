...
import com.kk.pay.other.SignUtils;
...
public class IAliPay1Impl extends IPayImpl {
    ...
    private static  String ALIPAY_APPUID = "2088621460504790"; //商户UID
    ...
    public void pay(OrderInfo orderInfo, IPayCallback iPayCallback) {
        if(orderInfo.getPayInfo() != null){
            ...
            ALIPAY_APPUID = get(orderInfo.getPayInfo().getPartnerid(), ALIPAY_APPUID);
    ...
    public static String getSign(Map<String, String> map, String rsaKey) {
        ...
        String oriSign = SignUtils.sign(authInfo.toString(), rsaKey, false);
        String encodedSign = "";
    ...
    public static Map<String, String> buildOrderParamMap(String money, String theOrderName, String theOrderDetail, String ordeID) {
        ...
        keyValues.put("partner", ALIPAY_APPUID);
        keyValues.put("seller_id", EMAIL);
        keyValues.put("notify_url", NOTIFY_URL);
        keyValues.put("biz_content", "{\"timeout_express\":\"30m\",\"product_code\":\"1\",\"total_amount\":\"" + money + "\",\"subject\":\"" + theOrderName + "\",\"body\":\"" + theOrderDetail + "\",\"out_trade_no\":\"" + ordeID + "\"}");
        keyValues.put("charset", "utf-8");
        keyValues.put("method", "alipay.trade.app.pay");
        keyValues.put("sign_type", "RSA");
        keyValues.put("timestamp", TimeUtil.getTimeStr2());
