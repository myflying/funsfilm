...
import com.ant.funsfilm.ui.fragment.CategoryFragment;
import com.ant.funsfilm.ui.fragment.HomeFragment;
import com.ant.funsfilm.ui.fragment.MyInfoFragment;
...
public class MainActivity extends BaseActivity implements MovieView {
    ...
    //定义数组来存放Fragment界面
    private Class fragmentArray[] = {HomeFragment.class, CategoryFragment.class, HomeFragment.class, MyInfoFragment.class};
